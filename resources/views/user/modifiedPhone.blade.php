...
@section('container')
    ...
    @endphp
    <form class="mt-6" method="POST" action="/ActualizarTelefono">
        @csrf
        <input type="hidden" name="_id" value="{{$telefono->id}}">
        <div class="p-10 xs:p-0 mx-auto md:w-full mt-4 md:max-w-6xl">
            <div class="bg-white shadow w-full divide-y divide-gray-200 mt-4 p-2">
                ...
                <div class="px-5 py-7 mt-5">
                    <input type="number" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" min="10000000" max="79999999" placeholder="Numero de telefono:" value="{{ $telefono->telefono }}" name="phoneChange" />
                    ...
                    <a href="/user/phone/" class="no-underline">
