    ...
    <div class="bg-gray-400">
        ...
        <div class="container my-12 mx-auto px-4 md:px-12" >
            <form class="flex flex-wrap -mx-1 lg:-mx-4" method="POST" action="admonPreferences">
                ...
                @endforeach
                <button type="submit" class="transition duration-200 bg-blue-500 mt-4 mb-4 hover:bg-blue-600 focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
