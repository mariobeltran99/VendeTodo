        ...
        <div class="p-10 xs:p-0 mx-auto md:w-full mt-4 md:max-w-6xl">
            <div class="bg-white shadow w-full divide-y divide-gray-200 mt-4 p-2">
                ...
                <div class="px-5 py-7 mt-5">
                    <input type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" maxlength="100" placeholder="Nombre de la categoria:" value="{{ $listCategorie->nombre }}"/>
                    <input type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" maxlength="100" placeholder="Descripcion: " value="{{ $listCategorie->descripcion }}"/>
